...
export const getSkillComponent = (skillName: string): React.ReactNode => {
  const componentMap: Record<string, React.ReactNode> = {
    ...
    Video: <GenericSkillDrawer skillName="Video" />,
    "TailwindCSS": <GenericSkillDrawer skillName="TailwindCSS" />,
    "TanStack Query": <GenericSkillDrawer skillName="TanStack Query" />,
    "Next.js": <GenericSkillDrawer skillName="Next.js" />,
